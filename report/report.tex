...
De même, nous avons définie une base de connaissances \mintinline{lisp}{*questions*} pour les questions à poser : l'idée est d'avoir une question adaptée pour chaque attribut lorsque l'on veut connaître la valeur du fait associé. Les éléments de cette base sont aussi représentés sous forme de liste pointée.

\begin{listing}[H]
	\centering
	\inputminted[breaklines=true,linenos,firstline=27]{lisp}{../questions.lisp}
