...
'(
  ...
  (VBA . "Permet de créer des applications légères dans Excel pour traiter des petits ensemble de données ; solution accessible aux non developpeurs mais payante.")
  ...
  (HTML . "Formalisme de représentation de données utilisée par les pages web. La base du développement web")
    ...
    (Symfony . "Sûrement le framework PHP le plus populaire : formalisme Modèle-Vue-Contrôleur")
      ...
      (AJAX . "pour ''Asynchronous JAvascript and Xml''. Architecture qui permet de créer des applications dynamiques.")
