...
(defun intro ()
  ...
  (sleep 3)
  (format t "Celui-ci va vous poser des questions adaptées à ce que vous souhaitez réaliser~%")
  (format t "afin de trouver une ou plusieurs technologies adaptées.~%~%")
  (sleep 6)
  (format t "À chaque question, vous devrez répondre en sélectionnant une des propositions.~%")
  (sleep 3)
